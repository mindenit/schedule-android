...
class WeekPagerAdapter(
    ...
    private val onGroupClicked: (List<WeekScheduleView.WeekEvent>) -> Unit
    ...
    override fun onBindViewHolder(holder: WeekPageVH, position: Int) {
        ...
        holder.bind(start, eventsProvider(start), onEventClicked, onGroupClicked)
    }
    ...
    class WeekPageVH(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(startOfWeek: LocalDate, events: List<WeekScheduleView.WeekEvent>, onEventClicked: (WeekScheduleView.WeekEvent) -> Unit, onGroupClicked: (List<WeekScheduleView.WeekEvent>) -> Unit) {
            weekView.setWeek(startOfWeek, events)
            weekView.onEventClick = onEventClicked
            weekView.onGroupClick = onGroupClicked
            scroll.post {
